...
- [ ] Add profiles for the 008 so we can always use what we need (i.e. biofraphies should always have 23 = r, 34 = 1, 33 - 0, etc. )
- [ ] Add the auto update via api (already tested)
